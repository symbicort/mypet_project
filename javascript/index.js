        ...
        countRequest.onsuccess = function () {
            ...
            if (count === 0) {
                ...
                const inputDataShihTzu = {
                    petBreed: '시츄',
                    history: ' 시츄의 역사는 중국에서 시작되었습니다. 중국 황실을 위해서 티베트의 라사압소를 들여와 교배시켜 탄생했습니다. 페키니즈와 관련된 문서를 찾아보면 황실 전용견으로 키우고 있었다는 것을 알 수 있는데, 시츄의 경우 황실을 높이기 위해 사자와 외모적으로 흡사하게 생긴 견종을 키우고 싶어서 만들었다는 설이 유력합니다. \n 시츄는 시쭈나 시츄라고 부르기도 합니다. 이름의 유래는 사자입니다.',
                    feature: '시츄는 키(체고)는 약 22~27cm, 몸무게는 약 4~7kg의 소형견입니다. 평균 수명은 약 10~18년으로 알려져 있어요. 시츄는 이중모에 장모종이에요. 보통 이중모에 장모종이라고 하면 털이 굉장히 많이 빠지는 경우가 많은데요. \n 시츄는 털 빠짐이 꽤 있긴 하지만, 다른 이중모 및 장모종 견종보다 털 빠짐이 현저히 적답니다. 털 빠짐은 적은 편이지만 장모종이기 때문에 털을 주 3~4회 정도는 빗어주는 게 좋답니다.',
                    character: '모든 견종 중 가장 온순한 편이에요. 공격성도 낮고 온순한 성격으로 요구성 짖음도 거의 없는 편입니다. \n 분리불안 증상 또한 거의 없는 것으로 알려져 있으며 쾌활하고 사랑스러운 성격으로 알려져 있어 견주의 가족들과 함께하는 것을 좋아하며 충성스럽고 애정 어린 행동을 보여주기도 합니다. \n호기심이 많아 자신의 주변을 탐험하고 놀이하는 것을 즐기기도 합니다. 매우 사교적이기도 하여 낯선 사람이나 다른 개들과도 잘 지내는 경향이 있어요.',
                    caution: '시츄는 단두종으로 머리와 코가 납작해요. 콧구멍과 기관지도 매우 좁아서 호흡하는 걸 힘들어합니다. 그래서 호흡이 격해질 정도의 격한 운동은 피해야 합니다. \n 시츄는 유전적으로 안구 관련 질환에 취약해요. 특히, 백내장 및 진행성 망막 위축증이라는 질병으로 인해 실명이 될 가능성이 높습니다. \n 또한, 눈이 크고 튀어나와 있는 편이라 눈이 건조해지기 쉬우며, 눈에 상처나 염증이 생길 가능성도 높아서 주의가 필요해요.',
