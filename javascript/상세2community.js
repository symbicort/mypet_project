...
var savedComments = localStorage.getItem('comments2');
if (savedComments) {
    document.getElementById('commentList2').innerHTML = savedComments;
}
}

// 로컬 스토리지에 댓글 저장
function saveCommentsToLocalStorage() {
var commentListHtml = document.getElementById('commentList2').innerHTML;
